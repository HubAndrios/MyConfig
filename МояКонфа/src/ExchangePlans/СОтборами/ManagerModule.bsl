...
Процедура ОпределитьНастройки(Настройки, ИдентификаторНастройки = "") Экспорт
	...
	Настройки.Вставить("ЗаголовокКомандыДляСозданияНовогоОбменаДанными", НСтр("ru = 'РИБ с фильтрами'"));
	Настройки.Вставить("ЗаголовокПомощникаСозданияОбмена",               НСтр("ru = 'Настройка распределенной информационной базы с отборами'"));
	Настройки.Вставить("ЗаголовокУзлаПланаОбмена",                       НСтр("ru = 'Узел РИБ с фильтрами'"));
...
// Возвращает строку с пояснениями того, что нужно сделать перед
// загрузкой документов в инфомарционную базу
//
...
// Возвращает строку с пояснениями того, что нужно сделать перед
// загрузкой документов в инфомарционную базу корреспондента
//
...
// Процедура выполняет проверку параметров учета
// перед загрузкой документов в информационную базу.
//
...
Функция ПодробнаяИнформацияПоОбмену(ИдентификаторНастройки = "") Экспорт
	Возврат "ПланОбмена.СОтборами.Форма.ПодробнаяИнформация";
КонецФункции
...
Функция ИмяФайлаНастроекДляПриемника() Экспорт
	...
	Возврат "Настройки обмена для УТ (С отборами)";
