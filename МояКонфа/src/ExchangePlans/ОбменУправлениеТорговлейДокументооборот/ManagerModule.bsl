...
Функция ИмяФайлаНастроекДляПриемника() Экспорт
	...
	Возврат НСтр("ru = 'Настройки обмена УТ-ДО'");
...
Функция КраткаяИнформацияПоОбмену(ИдентификаторНастройки = "") Экспорт
	...
	ПоясняющийТекст = НСтр("ru = 'Позволяет синхронизировать данные с конфигурацией ""1С:Документооборот""'");
...
Функция ПодробнаяИнформацияПоОбмену(ИдентификаторНастройки = "") Экспорт
	...
	Возврат "ПланОбмена.ОбменУправлениеТорговлейДокументооборот.Форма.ПодробнаяИнформация";
