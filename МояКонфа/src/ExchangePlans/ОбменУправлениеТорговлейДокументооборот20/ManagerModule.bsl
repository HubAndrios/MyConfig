...
Процедура ОпределитьНастройки(Настройки, ИдентификаторНастройки = "") Экспорт
	...
	Настройки.ЗаголовокПомощникаСозданияОбмена = НСтр("ru='Настройка синхронизации с 1С:Документооборотом, ред. 2.0'");
	Настройки.ЗаголовокУзлаПланаОбмена = НСтр("ru='Синхронизация с 1С:Документооборотом, ред. 2.0'");
...
Функция ИмяФайлаНастроекДляПриемника() Экспорт
	...
	Возврат НСтр("ru = 'Настройки обмена УТ 11 - ДО 2.0'");
...
Функция КраткаяИнформацияПоОбмену(ИдентификаторНастройки = "") Экспорт
	...
	ПоясняющийТекст = НСтр("ru = 'Позволяет синхронизировать данные между конфигурациями ""1С:Управление торговлей"" и ""1С:Документооборот"".'");
