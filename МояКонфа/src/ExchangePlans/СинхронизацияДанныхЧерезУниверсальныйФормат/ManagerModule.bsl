...
// Позволяет определить произвольные дополнительные данные для настройки обмена в базе-корреспонденте.
// Полученные данные могут быть использованы в обработчике ПриСозданииНаСервере в форме настройки узла плана обмена
// ФормаНастройкиЗначенийПоУмолчаниюБазыКорреспондента при настройке обмена данными с использованием помощника.
//
// Параметры:
//      ДополнительныеДанные – Структура – дополнительные данные, которые будут использованы в базе-корреспонденте при настройке обмена;
...
Процедура ОпределитьНастройки(Настройки, ИдентификаторНастройки) Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("УправлениеТорговлей") Тогда
		...
		Иначе
			...
			МассивНастроек.Добавить("ОбменБПКОРП30");
		КонецЕсли;
	...
	ИначеЕсли ИдентификаторНастройки = "ОбменБПКОРП30" Тогда
		...
		Настройки.Вставить("ЗаголовокКомандыДляСозданияНовогоОбменаДанными", НСтр("ru = 'Бухгалтерия предприятия КОРП, редакция 3.0'"));
		Настройки.Вставить("ЗаголовокПомощникаСозданияОбмена",               НСтр("ru = 'Настройка синхронизации с программой ""Бухгалтерия предприятия КОРП, редакция. 3.0""'"));
		Настройки.Вставить("ЗаголовокУзлаПланаОбмена",                       НСтр("ru = 'Синхронизация с программой ""Бухгалтерия предприятия КОРП, редакция 3.0""'"));
		Настройки.Вставить("НаименованиеКонфигурацииКорреспондента",         НСтр("ru = 'Бухгалтерия предприятия КОРП, редакция 3.0'"));
		
	ИначеЕсли ИдентификаторНастройки = "ОбменУП2ЗУП3" Тогда
		
		Настройки.Вставить("ЗаголовокКомандыДляСозданияНовогоОбменаДанными", НСтр("ru = 'Зарплата и Управление Персоналом, редакция 3'"));
		Настройки.Вставить("ЗаголовокПомощникаСозданияОбмена",               НСтр("ru = 'Настройка синхронизации с программой ""Зарплата и Управление Персоналом, редакция 3""'"));
		Настройки.Вставить("ЗаголовокУзлаПланаОбмена",                       НСтр("ru = 'Синхронизация с программой ""Зарплата и Управление Персоналом, редакция 3""'"));
		Настройки.Вставить("НаименованиеКонфигурацииКорреспондента",         НСтр("ru = 'Зарплата и Управление Персоналом, редакция 3'"));
	...
	ОписаниеВариантаНастройкиОбмена = Настройки.ОписанияВариантовНастроекОбмена.Добавить();
	ОписаниеВариантаНастройкиОбмена.ИдентификаторНастройки = "ОбменКасса";
	ОписаниеВариантаНастройкиОбмена.ИмяКорреспондента      = "Касса";
	
	ОписаниеВариантаНастройкиОбмена = Настройки.ОписанияВариантовНастроекОбмена.Добавить();
	ОписаниеВариантаНастройкиОбмена.ИдентификаторНастройки = "ОбменБП30";
	ОписаниеВариантаНастройкиОбмена.ИмяКорреспондента      = "БухгалтерияПредприятия";
	
	ОписаниеВариантаНастройкиОбмена = Настройки.ОписанияВариантовНастроекОбмена.Добавить();
	ОписаниеВариантаНастройкиОбмена.ИдентификаторНастройки = "ОбменУПБП";
	ОписаниеВариантаНастройкиОбмена.ИмяКорреспондента      = "БухгалтерияПредприятия";
	
	ОписаниеВариантаНастройкиОбмена = Настройки.ОписанияВариантовНастроекОбмена.Добавить();
	ОписаниеВариантаНастройкиОбмена.ИдентификаторНастройки = "ОбменУТБП";
	ОписаниеВариантаНастройкиОбмена.ИмяКорреспондента      = "БухгалтерияПредприятия";
	...
	ОписаниеВариантаНастройкиОбмена = Настройки.ОписанияВариантовНастроекОбмена.Добавить();
	ОписаниеВариантаНастройкиОбмена.ИдентификаторНастройки = "ОбменБПКОРП30";
	ОписаниеВариантаНастройкиОбмена.ИмяКорреспондента      = "БухгалтерияПредприятияКОРП";
	
	ОписаниеВариантаНастройкиОбмена = Настройки.ОписанияВариантовНастроекОбмена.Добавить();
	ОписаниеВариантаНастройкиОбмена.ИдентификаторНастройки = "ОбменУП2ЗУП3";
	ОписаниеВариантаНастройкиОбмена.ИмяКорреспондента      = "ЗарплатаИУправлениеПерсоналом";
...
//
// Возвращаемое значение:
//    Булево  - признак возможности использовать план обмена в модели сервиса
//
...
//
// Возвращаемое значение:
//    Булево  - признак возможности использовать обмен данными с корреспондентом, работающим в модели сервиса
//
...
// Возвращает строку содержащую пространство имен XDTO пакета, без номера версии формата.
// 
// Возвращаемое значение:
//  Строка - пространство имен XDTO пакета, без номера версии формата.
//
