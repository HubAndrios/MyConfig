...
Процедура ОтключитьУчастниковИБ(Команда)
	...
	ПоказатьВопрос(Новый ОписаниеОповещения("ОтключитьЗавершение", ЭтотОбъект), ТекстВопроса, РежимДиалогаВопрос.ОКОтмена);
...
Процедура УдалитьОрганизацииВСервисе(Команда)
	...
	ПоказатьВопрос(Новый ОписаниеОповещения("ОтключитьОрганизацииВСервисЗавершение", ЭтотОбъект),
...
Процедура УдалитьОрганизациюВСервисе(Команда)
	...
	|Обмен электронными документами и другие функции сервиса будут недоступны.'");
	ПоказатьВопрос(Новый ОписаниеОповещения("УдалитьОрганизациюЗавершение", ЭтотОбъект),
		ТекстВопроса, РежимДиалогаВопрос.ОКОтмена);
...
Процедура ОтключитьУчастниковОдиночноеИБ(Команда)
	...
	ПоказатьВопрос(Новый ОписаниеОповещения("ОтключитьЗавершениеОдиночное", ЭтотОбъект),
		ТекстВопроса, РежимДиалогаВопрос.ОКОтмена);
...
Процедура ОбновитьВидимостьДоступностьЭлементов()
	...
	Элементы.ГруппаОтключенияОдиночное.Видимость   = ОдиночнаяРегистрация;
	...
	Элементы.ГруппаОтключенияОдиночное.Доступность = УчастникЗарегистрирован;
