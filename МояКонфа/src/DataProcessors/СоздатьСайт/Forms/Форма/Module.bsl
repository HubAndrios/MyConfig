...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	EmailРегистрацииСайта = Обработки.СоздатьСайт.КонтактнаяИнформация(
		ТекПользователь, 
		"EmailПользователя");
	...
	ОбменССайтомПереопределяемый.ПриСозданииНаСервереФормаСоздатьСайт(ЭтотОбъект);
...
Функция ГотовностьСайтаНаСервере()
	...
	ПараметрыСозданияСайта = ПараметрыСозданияСайта();
	ДанныеСайта = Обработки.СоздатьСайт.ДанныеСозданияСайта(ПараметрыСозданияСайта);
