...
Процедура ТаблицаОстатковНоменклатураОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	МассивСтрок = Объект.ТаблицаОстатков.НайтиСтроки(Новый Структура("Номенклатура, Характеристика", ВыбранноеЗначение, ИнтеграцияЕГАИСВызовСервера.ПустоеЗначениеОпределяемогоТипа("ХарактеристикаНоменклатуры")));
...
Процедура ПроверитьКорректностьОстатков(ПроверяемыеСтроки = Неопределено)
	...
	Если ПроверяемыеСтроки = Неопределено Тогда
		Отбор = Новый Структура("Номенклатура, Характеристика",
			ИнтеграцияЕГАИСВызовСервера.ПустоеЗначениеОпределяемогоТипа("Номенклатура"),
			ИнтеграцияЕГАИСВызовСервера.ПустоеЗначениеОпределяемогоТипа("ХарактеристикаНоменклатуры"));
...
Функция ВставитьСтрокуПриИзмененииНоменклатуры()
	...
	ТекущиеДанные.Номенклатура = ИнтеграцияЕГАИСВызовСервера.ПустоеЗначениеОпределяемогоТипа("Номенклатура");
	ТекущиеДанные.Характеристика = ИнтеграцияЕГАИСВызовСервера.ПустоеЗначениеОпределяемогоТипа("ХарактеристикаНоменклатуры");
...
Процедура ЗаполнитьНесопоставленнуюПродукцию()
	...
	Для Каждого СтрокаТаблицы Из ТаблицаОстатков Цикл
		ОтборПустаяНоменклатура = Новый Структура("Номенклатура, Характеристика, АлкогольнаяПродукция",
			ИнтеграцияЕГАИС.ПустоеЗначениеОпределяемогоТипа("Номенклатура"), ИнтеграцияЕГАИС.ПустоеЗначениеОпределяемогоТипа("ХарактеристикаНоменклатуры"), СтрокаТаблицы.АлкогольнаяПродукция);
		
		ОтборПустаяАлкогольнаяПродукция = Новый Структура("Номенклатура, Характеристика, АлкогольнаяПродукция",
			СтрокаТаблицы.Номенклатура, ИнтеграцияЕГАИС.ПустоеЗначениеОпределяемогоТипа("ХарактеристикаНоменклатуры"), Справочники.КлассификаторАлкогольнойПродукцииЕГАИС.ПустаяСсылка());
...
Процедура УстановитьУсловноеОформление()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(
		...
		ИнтеграцияЕГАИС.ПустоеЗначениеОпределяемогоТипа("Номенклатура"),
...
Процедура ЗаполнитьСлужебныеРеквизитыТабличныхЧастей()
	...
	МассивСтрок = ВремТаблица.НайтиСтроки(Новый Структура("Номенклатура", ИнтеграцияЕГАИС.ПустоеЗначениеОпределяемогоТипа("Номенклатура")));
	Для Каждого СтрокаТаблицы Из МассивСтрок Цикл
