...
Процедура ДалееКШагуСформированныеДокументыНаСервере()
	...
	Замер = Производительность.НачатьЗамерВремени("Обработка.УправлениеПеремещениемОбособленныхТоваров.Форма.РабочееМесто.ДалееКШагуСформированныеДокументы.%1");
	
	КоличествоСозданныхДокументов = СоздатьДокументы();
	
	// Окончание замера производительности.
	Производительность.ЗакончитьЗамерВремени(Замер, КоличествоСозданныхДокументов);
