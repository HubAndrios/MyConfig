...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	ИначеЕсли ИсточникВыбора.ИмяФормы = "Справочник.ХарактеристикиНоменклатуры.Форма.ФормаВыбора" Тогда
		...
		ДобавитьПоддержаниеЗапасаХарактеристикиНаСервере(ТекущаяНоменклатура, ВыбранноеЗначение, Объект.Склад, ТекущаяГруппировка);
		Элементы.СписокПоддерживаемыхЗапасов.Обновить();
...
&НаКлиенте
Процедура ДобавитьХарактиристики(Команда)
	
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.НастройкаПоддержанияЗапасов.Форма.Форма.Команда.ДобавитьХарактиристики");
...
Процедура УдалитьХарактеристики(Команда)
	...
	// &ЗамерПроизводительности
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Обработка.НастройкаПоддержанияЗапасов.Форма.Форма.Команда.УдалитьХарактиристики");
...
Процедура НастроитьФормуПоПравамИФункциональнымОпциям()
	...
	Если ТолькоПросмотр Тогда
		...
		Элементы.СписокПоддерживаемыхЗапасовКонтекстноеМенюДобавитьХарактиристики.Видимость	= Ложь;
...
Процедура УстановитьДоступностьКнопокДобавления(Форма, Доступно)
	...
	Форма.Элементы.СписокПоддерживаемыхЗапасовДобавитьХарактиристики.Доступность				= Доступно;
	Форма.Элементы.СписокПоддерживаемыхЗапасовКонтекстноеМенюДобавитьХарактиристики.Доступность	= Доступно;
...
&НаСервереБезКонтекста
Процедура ДобавитьПоддержаниеЗапасаХарактеристикиНаСервере(Номенклатура, Характеристика, Склад, Группировка)
