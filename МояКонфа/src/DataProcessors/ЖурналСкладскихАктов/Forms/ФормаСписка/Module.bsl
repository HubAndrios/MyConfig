...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокАктов.ТекстЗапроса = СтрЗаменить(СписокАктов.ТекстЗапроса, "&СтатусПроверки КАК СтатусПроверки,", "");
	СписокАктов.ТекстЗапроса = СтрЗаменить(СписокАктов.ТекстЗапроса, "&ИндикаторПроверки КАК ИндикаторПроверки,", "");
