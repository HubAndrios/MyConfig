...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	|	ЕСТЬNULL(ДанныеШапки.Соглашение.ВариантПриемкиТоваров, ЗНАЧЕНИЕ(Перечисление.ВариантыПриемкиТоваров.ПустаяСсылка)) КАК ВариантПриемкиТоваров
	|ИЗ
	...
	ВариантПриемкиТоваров = ?(ЗначениеЗаполнено(Реквизиты.ВариантПриемкиТоваров),
		Реквизиты.ВариантПриемкиТоваров, Константы.ВариантПриемкиТоваров.Получить());
	Если ЗакупкиСервер.РаспоряжениеНаПриемкуТовараНакладная(ВариантПриемкиТоваров) Тогда
...
Функция ТекстЗапросаВтТовары(Запрос, ТекстыЗапроса)
	...
	|	СоглашениеСПоставщиком.Ссылка                                  КАК СоглашениеДокументаОснования,
	...
	|		ПО ТаблицаТовары.ДокументОснование.Соглашение = СоглашениеСПоставщиком.Соглашение
	|ГДЕ
