...
Процедура АвтоТест_РассчитатьВзаимозачет(Команда) Экспорт
	...
	ЕстьСтрокиДтЗадолженности = НЕ Объект.ДебиторскаяЗадолженность.Количество() = 0
		ИЛИ НЕ (Объект.ДебиторскаяЗадолженность.Количество() = 1 И Не ЗначениеЗаполнено(Объект.ДебиторскаяЗадолженность[0].Заказ));
		
	ЕстьСтрокиКтЗадолженности = НЕ Объект.КредиторскаяЗадолженность.Количество() = 0
		ИЛИ НЕ (Объект.КредиторскаяЗадолженность.Количество() = 1 И Не ЗначениеЗаполнено(Объект.КредиторскаяЗадолженность[0].Заказ));
