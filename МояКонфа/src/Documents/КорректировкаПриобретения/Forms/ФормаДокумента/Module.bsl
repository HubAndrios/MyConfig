...
Процедура УстановитьВариантыОтражения(Команда)
	...
	УстановитьВариантыОтраженияФрагментБезИнвентаризации(ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, ЕстьУвеличениеКоличестваБезИнвентаризации,
		ЕстьУменьшениеКоличестваБезИнвентаризации, ЕстьУменьшениеКоличестваПоОрдерномуСкладу);
...
Процедура УстановитьВариантыОтраженияПослеВыбора(Результат, ДополнительныеПараметры) Экспорт
    ...
    УстановитьВариантыОтраженияФрагментБезИнвентаризации(ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, ЕстьУвеличениеКоличестваБезИнвентаризации, ЕстьУменьшениеКоличестваБезИнвентаризации, ЕстьУменьшениеКоличестваПоОрдерномуСкладу);

КонецПроцедуры

&НаКлиенте
Процедура УстановитьВариантыОтраженияФрагментБезИнвентаризации(Знач ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, Знач ЕстьУвеличениеКоличестваБезИнвентаризации, Знач ЕстьУменьшениеКоличестваБезИнвентаризации, Знач ЕстьУменьшениеКоличестваПоОрдерномуСкладу)
	...
	УстановитьВариантыОтраженияФрагментПоОрдерномуСкладу(ВариантОтраженияУвеличениеКоличестваБезИнвентаризации, ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, ЕстьУменьшениеКоличестваБезИнвентаризации, ЕстьУменьшениеКоличестваПоОрдерномуСкладу);
...
&НаКлиенте
Процедура УстановитьВариантыОтраженияФрагментПоОрдерномуСкладу(Знач ВариантОтраженияУвеличениеКоличестваБезИнвентаризации, Знач ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, Знач ЕстьУменьшениеКоличестваБезИнвентаризации, Знач ЕстьУменьшениеКоличестваПоОрдерномуСкладу)
	...
	УстановитьВариантыОтраженияБезИнвентаризации(ВариантОтраженияУвеличениеКоличестваБезИнвентаризации, ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, ВариантОтраженияУменьшениеКоличестваПоОрдерномуСкладу, ЕстьУменьшениеКоличестваБезИнвентаризации);
...
&НаКлиенте
Процедура УстановитьВариантыОтраженияБезИнвентаризации(Знач ВариантОтраженияУвеличениеКоличестваБезИнвентаризации, Знач ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, Знач ВариантОтраженияУменьшениеКоличестваПоОрдерномуСкладу, Знач ЕстьУменьшениеКоличестваБезИнвентаризации)
	...
	УстановитьВариантыОтраженияФрагмент(ВариантОтраженияУвеличениеКоличестваБезИнвентаризации, ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, ВариантОтраженияУменьшениеКоличестваБезИнвентаризации, ВариантОтраженияУменьшениеКоличестваПоОрдерномуСкладу);
...
&НаКлиенте
Процедура УстановитьВариантыОтраженияФрагмент(Знач ВариантОтраженияУвеличениеКоличестваБезИнвентаризации, Знач ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, Знач ВариантОтраженияУменьшениеКоличестваБезИнвентаризации, Знач ВариантОтраженияУменьшениеКоличестваПоОрдерномуСкладу)
