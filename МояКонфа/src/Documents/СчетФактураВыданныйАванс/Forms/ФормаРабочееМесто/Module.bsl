...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПроверкаКонтрагентов.ПриСозданииНаСервереСписокДокументов(СписокСчетФактураВыданныйАванс);
	
	Если Не ПроверкаКонтрагентовВызовСервера.ИспользованиеПроверкиВозможно() Тогда
		Элементы.СписокСчетФактураВыданныйЕстьОшибкиПроверкиКонтрагентов.Видимость = Ложь;
	КонецЕсли;
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыСписокСчетФактураВыданный

&НаКлиенте
Процедура СписокСчетФактураВыданныйПриАктивизацииСтроки(Элемент)
...
Процедура ОбновитьДанныеФормы()
	...
	ГруппаОтбораПериода = ОбщегоНазначенияКлиентСервер.СоздатьГруппуЭлементовОтбора(
		ОбщегоНазначенияУТКлиентСервер.ПолучитьОтборДинамическогоСписка(СписокСчетФактураВыданныйАванс).Элементы,
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(СписокСчетФактураВыданныйАванс, 
