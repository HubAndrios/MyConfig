...
Процедура ОбновитьИнформациюПоЗаказам()
	...
	ПараметрыОбновления.ИмяГруппыКолонокВТабличнойЧасти   = "ТоварыГруппаЗаказНаВнутренееПотребление";
	...
	Элементы.НаправлениеДеятельности.Доступность = ДоступностьНаправленияДеятельности(
		Не ЗначениеЗаполнено(Объект.ЗаказНаВнутреннееПотребление)
		И СписокЗаказов.Количество() = 0);
