...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоступныеТипыНазначений = Новый Массив;
	ДоступныеТипыНазначений.Добавить(Перечисления.ТипыНазначений.ПустаяСсылка());
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Список, "ДоступныеТипыНазначений", ДоступныеТипыНазначений);
