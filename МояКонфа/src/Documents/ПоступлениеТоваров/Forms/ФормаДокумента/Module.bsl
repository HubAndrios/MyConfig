...
Процедура ОчиститьРаспоряжение()
	...
	ИменаРеквизитов = "Партнер,Контрагент,Склад,Организация,ХозяйственнаяОперация";
	...
	Если Объект.Партнер <> ЗначенияРеквизитов.Партнер
		...
		Или Объект.Склад <> ЗначенияРеквизитов.Склад
...
Процедура ПриИзмененииДоговораСервер()
	...
	Если ЗначениеЗаполнено(Объект.Договор) Тогда
		...
		ДокументОбъект.ЗаполнитьХозяйственнуюОперациюПоДоговору(Объект.Договор);
...
Функция ПолучитьХозяйственнуюОперациюДоговора(ХозяйственнаяОперация)
	...
	ХозОперацииЗакупкаУПоставщика = ЗакупкиВызовСервера.ХозяйственныеОперацииПоОсновной(
	...
	ИначеЕсли ХозОперацииЗакупкаВСтранахЕАЭС.Найти(ХозяйственнаяОперация) <> Неопределено Тогда
		ХозяйственнаяОперацияДоговора = ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.ЗакупкаВСтранахЕАЭС");
	ИначеЕсли ХозОперацииЗакупкаПоИмпорту.Найти(ХозяйственнаяОперация) <> Неопределено Тогда
		ХозяйственнаяОперацияДоговора = ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.ЗакупкаПоИмпорту");
	КонецЕсли;
...
Функция ВыбранаОперацияБезЦен(ХозяйственнаяОперация)
	...
	Возврат ХозяйственнаяОперация = ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.ЗакупкаВСтранахЕАЭСТоварыВПути")
...
Функция СкладыРаспоряжения()
	...
	Иначе
		...
		|	ГДЕ
		|		ТоварыКОформлениюПоступления.ДокументПоступления = &Ссылка) КАК ВложенныйЗапрос";
