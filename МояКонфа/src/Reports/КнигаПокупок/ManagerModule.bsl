...
//
Функция ПолучитьЗаписиКнигиПокупок(СтруктураПараметров) Экспорт
	...
	УчетНДСПереопределяемый.ПолучитьСчетаФактурыДокументыКнигаПокупок(Запрос);	
	...
	|			И ЗаписиКнигиПокупок.ГоловнаяОрганизация = ТаблицаСчетаФактурыДокументы.ГоловнаяОрганизация
	|ГДЕ
	...
	|	ПодготовленныеЗаписиКнигиПокупок.ГоловнаяОрганизация КАК ГоловнаяОрганизация,
...
Функция ПолучитьЗаписиДополнительныхЛистовКнигиПокупок(СтруктураПараметров) Экспорт
	...
	|	ВЫБОР
	|		КОГДА ЗаписиКнигиПокупок.ЭтоАвансыПолученные
	|			ТОГДА ЕСТЬNULL(ТаблицаСчетаФактурыДокументы.ДатаДокументаОснования, ЗаписиКнигиПокупок.СчетФактураДата)
