...
//                  на основании которого необходимо создать электронный документ.
//  СтруктураЭД - Структура - дополнительные параметры для формирования данных электронного документа. Содержит поля:
//       * ВидЭД - ПеречислениеСсылка.ВидыЭДОбменСБаками - вид электронного документа
//       * Направление - ПеречислениеСсылка.НаправленияЭД - вид электронного документа
//       * Идентификатор - Строка - уникальный идентификатор электронного документа
//       * СсылкаНаОбъект - ДокументСсылка - ссылка на объект информационной базы, на основании которого необходимо создать электронный документ.
//       * НомерДокументаОтправителя - Строка - номер электронного документа.
//       * ДатаДокументаОтправителя - Строка - дата электронного документа.
...
//  ДеревоДокумента - ДеревоЗначений - (возвращаемое значение)соответствует макету ПлатежноеПоручение обработки ОбменСБанками.
//
