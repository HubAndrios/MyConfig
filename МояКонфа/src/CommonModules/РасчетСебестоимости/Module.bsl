...
Процедура СкорректироватьСтоимостьВозвратовПрошлыхПериодов(ПараметрыРасчета)
	...
	|		КОГДА ТаблицаВозвратов.ПоЦенеПродажи22
...
Процедура СформироватьУзлыКорректировкиСписанияСтоимости(ПараметрыРасчета)
	...
	|		ВЫБОР
	|			КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ДопРасходы) КАК ЧИСЛО(23,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	|		КОНЕЦ КАК ЧИСЛО(23,10))  			   КАК СтоимостьДопРасходы,
	|	ВЫРАЗИТЬ(
	|		ВЫБОР
	|			КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ДопРасходыБезНДС) КАК ЧИСЛО(23,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	...
	|		ВЫБОР
	|			КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ПостатейныеПостоянныеСНДС) КАК ЧИСЛО(23,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	|		КОНЕЦ КАК ЧИСЛО(23,10))  			   КАК ПостатейныеПостоянныеСНДС,
	|	ВЫРАЗИТЬ(
	|		ВЫБОР
	|			КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ПостатейныеПостоянныеБезНДС) КАК ЧИСЛО(23,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	|		КОНЕЦ КАК ЧИСЛО(23,10))  			   КАК ПостатейныеПостоянныеБезНДС,
	
	|	ВЫРАЗИТЬ(
	|		ВЫБОР
	|			КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ПостатейныеПеременныеСНДС) КАК ЧИСЛО(23,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	|		КОНЕЦ КАК ЧИСЛО(23,10))  			   КАК ПостатейныеПеременныеСНДС,
	|	ВЫРАЗИТЬ(
	|		ВЫБОР
	|			КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|				ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ПостатейныеПеременныеБезНДС) КАК ЧИСЛО(23,10)) / СУММА(ВложенныйЗапрос.Количество)
	|			ИНАЧЕ 0
	|		КОНЕЦ КАК ЧИСЛО(23,10))  			   КАК ПостатейныеПеременныеБезНДС,
...
Процедура ЗарегистрироватьСтоимость(ПараметрыРасчета, РегистрацияСтоимостиРегл)
	...
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ДопРасходы КАК ЧИСЛО(23,10)) / Остатки.Количество 		 	 КАК ЧИСЛО (23, 10)) КАК СтоимостьДопРасходы,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ДопРасходыБезНДС КАК ЧИСЛО(23,10)) / Остатки.Количество  		 КАК ЧИСЛО (23, 10)) КАК СтоимостьДопРасходыБезНДС,
	...
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ПостатейныеПостоянныеСНДС КАК ЧИСЛО(23,10)) / Остатки.Количество 		 КАК ЧИСЛО (23, 10)) КАК ПостатейныеПостоянныеСНДС,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ПостатейныеПостоянныеБезНДС КАК ЧИСЛО(23,10)) / Остатки.Количество	 КАК ЧИСЛО (23, 10)) КАК ПостатейныеПостоянныеБезНДС,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ПостатейныеПеременныеСНДС КАК ЧИСЛО(23,10)) / Остатки.Количество 		 КАК ЧИСЛО (23, 10)) КАК ПостатейныеПеременныеСНДС,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ПостатейныеПеременныеБезНДС КАК ЧИСЛО(23,10)) / Остатки.Количество	 КАК ЧИСЛО (23, 10)) КАК ПостатейныеПеременныеБезНДС,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.СтоимостьУпр КАК ЧИСЛО(23,10)) / Остатки.Количество 		 			 КАК ЧИСЛО (23, 10)) КАК СтоимостьУпр,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ДопРасходыУпр КАК ЧИСЛО(23,10)) / Остатки.Количество 		 			 КАК ЧИСЛО (23, 10)) КАК ДопРасходыУпр,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ТрудозатратыУпр КАК ЧИСЛО(23,10)) / Остатки.Количество 		 		 КАК ЧИСЛО (23, 10)) КАК ТрудозатратыУпр,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ПостатейныеПостоянныеУпр КАК ЧИСЛО(23,10)) / Остатки.Количество 		 КАК ЧИСЛО (23, 10)) КАК ПостатейныеПостоянныеУпр,
	|	ВЫРАЗИТЬ(ВЫРАЗИТЬ(Остатки.ПостатейныеПеременныеУпр КАК ЧИСЛО(23,10)) / Остатки.Количество 		 КАК ЧИСЛО (23, 10)) КАК ПостатейныеПеременныеУпр,
	|	ВЫБОР
...
Процедура СформироватьУзлыКорректировкиСписанияСтоимостиРегл(ПараметрыРасчета)
	...
	|	ВЫРАЗИТЬ(
	|		ВЫБОР КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|			ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.СтоимостьУпр) КАК ЧИСЛО(23,10)) / СУММА(ВложенныйЗапрос.Количество)
	|		ИНАЧЕ
	|			0
	...
	|	ВЫРАЗИТЬ(
	|		ВЫБОР КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|			ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ДопРасходыУпр) КАК ЧИСЛО(23,10)) / СУММА(ВложенныйЗапрос.Количество)
	|		ИНАЧЕ
	|			0
	|		КОНЕЦ КАК ЧИСЛО(23,10))   КАК ДопРасходыУпр,
	|	ВЫРАЗИТЬ(
	|		ВЫБОР КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|			ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.СтоимостьЗабалансовая) КАК ЧИСЛО(23,10)) / СУММА(ВложенныйЗапрос.Количество)
	|		ИНАЧЕ
	...
	|	ВЫРАЗИТЬ(
	|		ВЫБОР КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|			ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ТрудозатратыУпр) КАК ЧИСЛО(23,10)) / СУММА(ВложенныйЗапрос.Количество)
	|		ИНАЧЕ
	|			0
	|		КОНЕЦ КАК ЧИСЛО(23,10))   КАК ТрудозатратыУпр,
	|	ВЫРАЗИТЬ(
	|		ВЫБОР КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|			ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ПостатейныеПостоянныеУпр) КАК ЧИСЛО(23,10)) / СУММА(ВложенныйЗапрос.Количество)
	|		ИНАЧЕ
	|			0
	|		КОНЕЦ КАК ЧИСЛО(23,10))   КАК ПостатейныеПостоянныеУпр,
	|	ВЫРАЗИТЬ(
	|		ВЫБОР КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|			ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.ПостатейныеПеременныеУпр) КАК ЧИСЛО(23,10)) / СУММА(ВложенныйЗапрос.Количество)
	|		ИНАЧЕ
	|			0
	|		КОНЕЦ КАК ЧИСЛО(23,10))   КАК ПостатейныеПеременныеУпр
	|
	|ПОМЕСТИТЬ ВтУзлыКорректировки
	|ИЗ
	|
...
Процедура СписатьОшибкиОкругленияРасчетаСебестоимости(ПараметрыРасчета)
	...
	|		И Себестоимость.ДопРасходы МЕЖДУ -&ЗначениеПогрешностиСтоимость И &ЗначениеПогрешностиСтоимость
	|		И Себестоимость.ДопРасходыБезНДС МЕЖДУ -&ЗначениеПогрешностиСтоимость И &ЗначениеПогрешностиСтоимость
	|		И Себестоимость.СтоимостьРегл МЕЖДУ -&ЗначениеПогрешностиСтоимость И &ЗначениеПогрешностиСтоимость
	|		И Себестоимость.СтоимостьУпр МЕЖДУ -&ЗначениеПогрешностиСтоимость И &ЗначениеПогрешностиСтоимость
	...
	|		И Себестоимость.ПостатейныеПостоянныеСНДС МЕЖДУ -&ЗначениеПогрешностиСтоимость И &ЗначениеПогрешностиСтоимость
	|		И Себестоимость.ПостатейныеПостоянныеБезНДС МЕЖДУ -&ЗначениеПогрешностиСтоимость И &ЗначениеПогрешностиСтоимость
	|		И Себестоимость.ПостатейныеПеременныеСНДС МЕЖДУ -&ЗначениеПогрешностиСтоимость И &ЗначениеПогрешностиСтоимость
	|		И Себестоимость.ПостатейныеПеременныеБезНДС МЕЖДУ -&ЗначениеПогрешностиСтоимость И &ЗначениеПогрешностиСтоимость
	...
	|		И Себестоимость.ПостатейныеПостоянныеРегл МЕЖДУ -&ЗначениеПогрешностиСтоимость И &ЗначениеПогрешностиСтоимость
	|		И Себестоимость.ПостатейныеПеременныеРегл МЕЖДУ -&ЗначениеПогрешностиСтоимость И &ЗначениеПогрешностиСтоимость
	|		И Себестоимость.СтоимостьУпр МЕЖДУ -&ЗначениеПогрешностиСтоимость И &ЗначениеПогрешностиСтоимость
	|		И Себестоимость.ДопРасходыУпр МЕЖДУ -&ЗначениеПогрешностиСтоимость И &ЗначениеПогрешностиСтоимость
	|		И Себестоимость.ТрудозатратыУпр МЕЖДУ -&ЗначениеПогрешностиСтоимость И &ЗначениеПогрешностиСтоимость
	|		И Себестоимость.ПостатейныеПостоянныеУпр МЕЖДУ -&ЗначениеПогрешностиСтоимость И &ЗначениеПогрешностиСтоимость
	|		И Себестоимость.ПостатейныеПеременныеУпр МЕЖДУ -&ЗначениеПогрешностиСтоимость И &ЗначениеПогрешностиСтоимость)
	|;
	|////////////////////////////////////////////////////////////////////////////////
	|
	|ВЫБРАТЬ ПЕРВЫЕ 0
...
Процедура РаспределитьРасходыБудущихПериодов(ПараметрыРасчета)
	...
	|	(ВЫБОР
	|		КОГДА Распределение.РаспределитьУпр ТОГДА Остатки.Сумма
	|		ИНАЧЕ 0 КОНЕЦ) КАК Сумма,
	|	(ВЫБОР
	|		КОГДА Распределение.РаспределитьУпр ТОГДА Остатки.СуммаУпр
	|		ИНАЧЕ 0 КОНЕЦ) КАК СуммаУпр,
	|	(ВЫБОР
	|		КОГДА Распределение.РаспределитьРегл ТОГДА Остатки.СуммаРегл
	|		ИНАЧЕ 0 КОНЕЦ) КАК СуммаРегл,
	|	(ВЫБОР
	|		КОГДА Распределение.РаспределитьРегл ТОГДА Остатки.ПостояннаяРазница
	|		ИНАЧЕ 0 КОНЕЦ) КАК ПостояннаяРазница,
	|	(ВЫБОР
	|		КОГДА Распределение.РаспределитьРегл ТОГДА Остатки.ВременнаяРазница
	...
	|		ПО Распределение.Организация = Остатки.Организация
	|		И Распределение.Подразделение = Остатки.Подразделение
	|		И Распределение.СтатьяРасходов = Остатки.СтатьяРасходов
	|		И Распределение.АналитикаРасходов = Остатки.АналитикаРасходов
	|		И Распределение.НаправлениеДеятельности = Остатки.НаправлениеДеятельности
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|ВЫБРАТЬ
	|	2 КАК Порядок,
...
Функция ТекстЗапросаДвиженияСтоимости()
	...
	|	ВЫРАЗИТЬ(УзлыКорректировки.ПостатейныеПостоянныеСНДС КАК ЧИСЛО(23,10))  	КАК ПостатейныеПостоянныеСНДС,
	|	ВЫРАЗИТЬ(УзлыКорректировки.ПостатейныеПостоянныеБезНДС КАК ЧИСЛО(23,10))  	КАК ПостатейныеПостоянныеБезНДС,
	|	ВЫРАЗИТЬ(УзлыКорректировки.ПостатейныеПеременныеСНДС КАК ЧИСЛО(23,10))     	КАК ПостатейныеПеременныеСНДС,
	|	ВЫРАЗИТЬ(УзлыКорректировки.ПостатейныеПеременныеБезНДС КАК ЧИСЛО(23,10))   	КАК ПостатейныеПеременныеБезНДС,
	|	ВЫРАЗИТЬ(УзлыКорректировки.СтоимостьУпр КАК ЧИСЛО(23,10))   				КАК СтоимостьУпр,
	|	ВЫРАЗИТЬ(УзлыКорректировки.ДопРасходыУпр КАК ЧИСЛО(23,10))   				КАК ДопРасходыУпр,
	|	ВЫРАЗИТЬ(УзлыКорректировки.ТрудозатратыУпр КАК ЧИСЛО(23,10))   				КАК ТрудозатратыУпр,
	|	ВЫРАЗИТЬ(УзлыКорректировки.ПостатейныеПостоянныеУпр КАК ЧИСЛО(23,10))   	КАК ПостатейныеПостоянныеУпр,
	|	ВЫРАЗИТЬ(УзлыКорректировки.ПостатейныеПеременныеУпр КАК ЧИСЛО(23,10))   	КАК ПостатейныеПеременныеУпр
...
Процедура РешитьСЛУ(ПараметрыРасчета, РасчетСтоимостиРегл)
	...
	Пока ТекущееОтклонение > ПараметрыРасчета.РешениеСЛУ.ТребуемаяТочность
	 И СчетчикИтераций <= ПараметрыРасчета.РешениеСЛУ.МаксимальноеКоличествоИтераций Цикл
		...
		|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ПостатейныеПостоянныеСНДС)   КАК ЧИСЛО(23,10)) КАК СвободныйКоэффициентПостатейныеПостоянныеСНДС,
		|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ПостатейныеПостоянныеБезНДС) КАК ЧИСЛО(23,10)) КАК СвободныйКоэффициентПостатейныеПостоянныеБезНДС,
		|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ПостатейныеПеременныеСНДС)   КАК ЧИСЛО(23,10)) КАК СвободныйКоэффициентПостатейныеПеременныеСНДС,
		|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ПостатейныеПеременныеБезНДС) КАК ЧИСЛО(23,10)) КАК СвободныйКоэффициентПостатейныеПеременныеБезНДС,
		|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.СтоимостьУпр) 				 КАК ЧИСЛО(23,10)) КАК СвободныйКоэффициентУпр,
		|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ДопРасходыУпр) 	 			 КАК ЧИСЛО(23,10)) КАК СвободныйКоэффициентДопРасходыУпр,
		|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ТрудозатратыУпр) 			 КАК ЧИСЛО(23,10)) КАК СвободныйКоэффициентТрудозатратыУпр,
		|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ПостатейныеПостоянныеУпр) 	 КАК ЧИСЛО(23,10)) КАК СвободныйКоэффициентПостатейныеПостоянныеУпр,
		|	ВЫРАЗИТЬ(МАКСИМУМ(УзлыКорректировки.ПостатейныеПеременныеУпр) 	 КАК ЧИСЛО(23,10)) КАК СвободныйКоэффициентПостатейныеПеременныеУпр,
		|
		...
		|				ТОГДА
		|					ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.Стоимость, 0) КАК ЧИСЛО(23,10))
		...
		|					+ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПостоянныеСНДС, 0) КАК ЧИСЛО(23,10))
		|					+ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПеременныеСНДС, 0) КАК ЧИСЛО(23,10))
		|			ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостояннаяРазница, 0) КАК ЧИСЛО(23,10))
		...
		|					* ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостояннаяРазницаЗнак, 0) КАК ЧИСЛО(23,10))
		...
		|			* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(23,10))
		|		КОНЕЦ) КАК ЧИСЛО(23,10))
		|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(23,10)) КАК ПостатейныеПостоянныеСНДС,
		|
		|	ВЫРАЗИТЬ(СУММА(
		|       ВЫБОР
		|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
		...
		|				ИНАЧЕ 0 КОНЕЦ
		|			+ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПостоянныеБезНДС, 0) КАК ЧИСЛО(23,10)))
		|			* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(23,10))
		|		КОНЕЦ) КАК ЧИСЛО(23,10))
		|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(23,10)) КАК ПостатейныеПостоянныеБезНДС,
		|	ВЫРАЗИТЬ(СУММА(
		|		ВЫБОР
		|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
		|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ) ТОГДА 0
		...
		|			* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(23,10))
		|		КОНЕЦ) КАК ЧИСЛО(23,10))
		|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(23,10)) КАК ПостатейныеПеременныеСНДС,
		|	ВЫРАЗИТЬ(СУММА(
		|		ВЫБОР
		|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
		|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ) ТОГДА 0
		...
		|					ТОГДА ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьБезНДС, 0) КАК ЧИСЛО(23,10))
		|				ИНАЧЕ 0 КОНЕЦ
		|			+ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПеременныеБезНДС, 0) КАК ЧИСЛО(23,10)))
		|			* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(23,10))
		|		КОНЕЦ) КАК ЧИСЛО(23,10))
		|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(23,10)) КАК ПостатейныеПеременныеБезНДС,
		|
		|	ВЫРАЗИТЬ(СУММА(
		|		ВЫБОР
		|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
		...
		|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПостатейныеПостоянныеУпр, ЛОЖЬ) ТОГДА 0
		|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПостатейныеПеременныеУпр, ЛОЖЬ) ТОГДА 0
		|			ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьУпр, 0) КАК ЧИСЛО(23,10))
		|				* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(23,10))
		|			КОНЕЦ) КАК ЧИСЛО(23,10))
		|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(23,10)) КАК СтоимостьУпр,
		|	ВЫРАЗИТЬ(СУММА(
		|       ВЫБОР
		|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
		|			ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ДопРасходыУпр, 0) КАК ЧИСЛО(23,10))
		|				* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(23,10))
		|			КОНЕЦ) КАК ЧИСЛО(23,10))
		|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(23,10)) КАК ДопРасходыУпр,
		|	ВЫРАЗИТЬ(СУММА(
		|       ВЫБОР
		|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
		|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ) ТОГДА 0
		|			ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ТрудозатратыУпр, 0) КАК ЧИСЛО(23,10))
		|				* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(23,10))
		|			КОНЕЦ) КАК ЧИСЛО(23,10))
		|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(23,10)) КАК ТрудозатратыУпр,
		|	ВЫРАЗИТЬ(СУММА(
		|		ВЫБОР
		|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
		|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ) ТОГДА 0
		...
		|					ТОГДА ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьУпр, 0) КАК ЧИСЛО(23,10))
		|				ИНАЧЕ 0 КОНЕЦ
		|			+ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПостоянныеУпр, 0) КАК ЧИСЛО(23,10)))
		|			* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(23,10))
		|		КОНЕЦ) КАК ЧИСЛО(23,10))
		|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(23,10)) КАК ПостатейныеПостоянныеУпр,
		|	ВЫРАЗИТЬ(СУММА(
		|		ВЫБОР
		|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПродукцияДавальца, ЛОЖЬ) ТОГДА 0
		|			КОГДА ЕСТЬNULL(ПеремещенияСписания.ПередачаВЭксплуатацию, ЛОЖЬ) ТОГДА 0
		...
		|					ТОГДА ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьУпр, 0) КАК ЧИСЛО(23,10))
		|				ИНАЧЕ 0 КОНЕЦ
		|			+ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПеременныеУпр, 0) КАК ЧИСЛО(23,10)))
		|			* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(23,10))
		|		КОНЕЦ) КАК ЧИСЛО(23,10))
		|		/ ВЫРАЗИТЬ(УзлыКорректировки.Количество КАК ЧИСЛО(23,10)) КАК ПостатейныеПеременныеУпр
		|
		...
		|		ИЛИ
		|		(ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.Стоимость, 0) КАК ЧИСЛО(23,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(15,3)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
		...
		|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПостоянныеСНДС, 0) КАК ЧИСЛО(23,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(15,3)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
		|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПостоянныеБезНДС, 0) КАК ЧИСЛО(23,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(15,3)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
		|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПеременныеСНДС, 0) КАК ЧИСЛО(23,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(15,3)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
		|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПеременныеБезНДС, 0) КАК ЧИСЛО(23,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(15,3)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
		...
		|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьУпр, 0) КАК ЧИСЛО(23,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(15,3)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
		|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ДопРасходыУпр, 0) КАК ЧИСЛО(23,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(15,3)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
		|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ТрудозатратыУпр, 0) КАК ЧИСЛО(23,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(15,3)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
		|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПостоянныеУпр, 0) КАК ЧИСЛО(23,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(15,3)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
		|		И ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПеременныеУпр, 0) КАК ЧИСЛО(23,10)) * ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(15,3)) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля))
		|
		|СГРУППИРОВАТЬ ПО
		...
		|	ВременнаяТаблицаРешений КАК ВременнаяТаблицаРешений
		|ГДЕ
		|	(ВременнаяТаблицаРешений.СвободныйКоэффициент + ВременнаяТаблицаРешений.Стоимость) МЕЖДУ -&ЗащитаОтПереполненияПоля И &ЗащитаОтПереполненияПоля
		|
		|ИНДЕКСИРОВАТЬ ПО
		|	НомерУзла
		|;
...
Процедура ИнициализироватьСвойстваЗапроса(Запрос, ПараметрыРасчета, ИспользоватьОбщийМенеджерВТ = Истина)
	...
	Запрос.УстановитьПараметр("ЗащитаОтПереполненияПоля", 	   ПараметрыРасчета.РешениеСЛУ.ЗащитаОтПереполненияПоля);
...
Функция ДобавитьЗаписьВТаблицуДвижений(ПараметрыРасчета, ИмяРегистра, ДанныеДвижения, КопируемыеПоля = Неопределено) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(Запись.Регистратор) Тогда
		...
		УниверсальныеМеханизмыПартийИСебестоимости.ЗарегистрироватьПроблемуВыполненияРасчета(
			...
			НСтр("ru='При формировании движений по себестоимости диагностированы ошибки'"),
			ТекстДляПротокола,
			ДанныеДвижения.ДокументДвижения);
