...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "ФайловыеФункцииСлужебныйВМоделиСервиса.УдалитьУстаревшиеОбработчикиОбновления";
	Обработчик.РежимВыполнения = "Оперативно";
...
// Удаление устаревшего отложенного обработчика обновления.
//
Процедура УдалитьУстаревшиеОбработчикиОбновления() Экспорт
	
	ОбновлениеИнформационнойБазы.УдалитьОтложенныйОбработчикИзОчереди("РегистрыСведений.УдалитьОчередьИзвлеченияТекста.ОбработатьДанныеДляПереходаНаНовуюВерсию");
