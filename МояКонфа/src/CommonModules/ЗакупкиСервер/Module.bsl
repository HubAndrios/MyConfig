...
// Возвращает хозяйственные операции, которая могут использоваться в документе. Если передать пустую ссылку на
...
Функция ХозяйственныеОперацииРаздельнойЗакупки(ПолноеИмяДокумента, Соглашение = Неопределено, Договор = Неопределено) Экспорт
	...
	|		ЕСТЬNULL(СоглашенияСПоставщиками.ХозяйственнаяОперация, ДоговорыКонтрагентов.ХозяйственнаяОперация) КАК ХозяйственнаяОперация
	|	ИЗ
	|		(ВЫБРАТЬ
	|			ДоговорыКонтрагентов.ВариантОформленияЗакупок КАК ВариантОформленияЗакупок,
	...
	|	И (ДанныеПараметров.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ЗакупкаУПоставщика)
	...
	|	И (ДанныеПараметров.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ЗакупкаПоИмпорту)
	|			ИЛИ ДанныеПараметров.ХозяйственнаяОперация ЕСТЬ NULL)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	...
	|	И (ДанныеПараметров.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ЗакупкаВСтранахЕАЭС)
	|			ИЛИ ДанныеПараметров.ХозяйственнаяОперация ЕСТЬ NULL)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ХозОперацииПоДоговору КАК ХозОперацииПоДоговору
	|		ПО ХозОперацииПоСоглашению.ХозОперация = ХозОперацииПоДоговору.ХозОперация
	|
	|УПОРЯДОЧИТЬ ПО
	|	Порядок";
...
Функция ЭтоХозяйственнаяОперацияРаздельнойЗакупки(ХозяйственнаяОперация) Экспорт
	...
	ХозяйственныеОперацииРаздельнойЗакупки = ОперацииРаздельнойЗакупки();
	Возврат ХозяйственныеОперацииРаздельнойЗакупки.Найти(ХозяйственнаяОперация) <> Неопределено;
	
КонецФункции

// Возвращает хозяйственных операций раздельной закупки
//
// Возвращаемое значение:
//  Массив - Массив хозяйственных операций раздельной закупки
//
Функция ОперацииРаздельнойЗакупки() Экспорт
	
	ХозяйственныеОперацииРаздельнойЗакупки = Новый Массив(10);
	ХозяйственныеОперацииРаздельнойЗакупки[0] = Перечисления.ХозяйственныеОперации.ЗакупкаУПоставщикаТоварыВПути;
	ХозяйственныеОперацииРаздельнойЗакупки[1] = Перечисления.ХозяйственныеОперации.ЗакупкаУПоставщикаФактуровкаПоставки;
	ХозяйственныеОперацииРаздельнойЗакупки[2] = Перечисления.ХозяйственныеОперации.ЗакупкаУПоставщикаПоступлениеИзТоваровВПути;
	ХозяйственныеОперацииРаздельнойЗакупки[3] = Перечисления.ХозяйственныеОперации.ЗакупкаУПоставщикаНеотфактурованнаяПоставка;
	ХозяйственныеОперацииРаздельнойЗакупки[4] = Перечисления.ХозяйственныеОперации.ЗакупкаВСтранахЕАЭСТоварыВПути;
	ХозяйственныеОперацииРаздельнойЗакупки[5] = Перечисления.ХозяйственныеОперации.ЗакупкаВСтранахЕАЭСФактуровкаПоставки;
	ХозяйственныеОперацииРаздельнойЗакупки[6] = Перечисления.ХозяйственныеОперации.ЗакупкаВСтранахЕАЭСПоступлениеИзТоваровВПути;
	ХозяйственныеОперацииРаздельнойЗакупки[7] = Перечисления.ХозяйственныеОперации.ЗакупкаВСтранахЕАЭСНеотфактурованнаяПоставка;
	ХозяйственныеОперацииРаздельнойЗакупки[8] = Перечисления.ХозяйственныеОперации.ЗакупкаПоИмпортуТоварыВПути;
	ХозяйственныеОперацииРаздельнойЗакупки[9] = Перечисления.ХозяйственныеОперации.ЗакупкаПоИмпортуПоступлениеИзТоваровВПути;
...
Функция ЗаполнитьТоварыПоФактическойПриемке(Товары, ПараметрыЗаполнения, ЕстьПринятыеТовары, ДополнительныеПараметрыПоиска = Неопределено) Экспорт
	...
	ИначеЕсли ТипПоступления = Тип("ДокументСсылка.ПриобретениеТоваровУслуг")
		Тогда
...
Процедура ЗаполнитьНастройкиВариантовПриемки(ВариантПриемкиТоваров, ОформлениеОрдера, ПриемкаТоваров = Неопределено) Экспорт
	...
	Если ВариантПриемкиТоваров = Перечисления.ВариантыПриемкиТоваров.МожетПроисходитьБезЗаказовИНакладных Тогда
		ОформлениеОрдера = "ПоСоглашению";
		ПриемкаТоваров = "НеРазделена";
	ИначеЕсли ВариантПриемкиТоваров = Перечисления.ВариантыПриемкиТоваров.НеРазделенаПоЗаказамИНакладным Тогда
		ОформлениеОрдера = "ПослеЗаказа"; 
		ПриемкаТоваров = "НеРазделена";
	ИначеЕсли ВариантПриемкиТоваров = Перечисления.ВариантыПриемкиТоваров.НеРазделенаПоНакладным Тогда
...
Функция ПолучитьВариантовПриемкиПоНастройкам(ОформлениеОрдера, ПриемкаТоваров) Экспорт
	...
	Если ОформлениеОрдера = "ПоСоглашению" И ПриемкаТоваров = "НеРазделена" Тогда
		ВариантПриемкиТоваров = Перечисления.ВариантыПриемкиТоваров.МожетПроисходитьБезЗаказовИНакладных
	...
	ИначеЕсли ОформлениеОрдера = "ПослеНакладной" И ПриемкаТоваров = "НеРазделена" Тогда
		ВариантПриемкиТоваров = Перечисления.ВариантыПриемкиТоваров.НеРазделенаПоНакладным
...
Функция ТекстЗапросаПроверкаПринимающихсяТоваровПоРаспоряжениям(ТипПоступления)
	...
	|				КОГДА &ВариантПриемкиТоваров В (ЗНАЧЕНИЕ(Перечисление.ВариантыПриемкиТоваров.НеРазделенаПоЗаказамИНакладным), ЗНАЧЕНИЕ(Перечисление.ВариантыПриемкиТоваров.МожетПроисходитьБезЗаказовИНакладных), ЗНАЧЕНИЕ(Перечисление.ВариантыПриемкиТоваров.НеРазделенаПоНакладным))
	|					ТОГДА ДокументПоступления = &Соглашение
	|				КОНЕЦ
...
Функция ТекстЗапросаПоРаспоряжениям(ТипПоступления)
	...
	Если ТипПоступления = Тип("ДокументСсылка.ПриобретениеТоваровУслуг") Тогда
		...
		|		ИНАЧЕ 
		|			ТоварыПоступления.Ссылка.Соглашение
...
Функция ТекстЗапросаПоНакладнойИлиСоглашению()
	...
	ТекстЗапроса = 
		...
		|				,
		|				ВЫБОР
		|					КОГДА &ВариантПриемкиТоваров В (ЗНАЧЕНИЕ(Перечисление.ВариантыПриемкиТоваров.РазделенаПоЗаказамИНакладным), ЗНАЧЕНИЕ(Перечисление.ВариантыПриемкиТоваров.РазделенаТолькоПоНакладным))
		|						ТОГДА ДокументПоступления = &Ссылка
		|					ИНАЧЕ ДокументПоступления = &Соглашение
