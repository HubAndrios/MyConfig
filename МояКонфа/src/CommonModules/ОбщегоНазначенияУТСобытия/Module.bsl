...
Процедура СинхронизироватьЗначенияПодчиненныхКонстант(ИмяКонстанты, ЗначениеКонстанты, Отказ)
	...
	ИначеЕсли ИмяКонстанты = "ИспользоватьГруппыФинансовогоУчета" Тогда
		
		ЗначениеПодчиненнойКонстанты = ЗначениеКонстанты И Константы.УчитыватьСебестоимостьТоваровПоВидамЗапасов.Получить();
	
		УстановитьЗначениеКонстанты(
			Константы.ФормироватьВидыЗапасовПоГруппамФинансовогоУчета, ЗначениеПодчиненнойКонстанты);
