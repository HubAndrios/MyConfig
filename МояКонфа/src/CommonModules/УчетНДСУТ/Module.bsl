...
Процедура ПолучитьДокументыОплаты(ПараметрыРасчета)
	...
	|	СчетаФактурыДокументы.Организация КАК Организация,
	|	СчетаФактурыДокументы.СчетФактура КАК СчетФактура,
	|	СписаниеДС_РасшифровкаПлатежа.Ссылка.Номер   КАК НомерДокументаОплаты,
	|	СписаниеДС_РасшифровкаПлатежа.Ссылка.Дата    КАК ДатаДокументаОплаты
	|ИЗ
	|	СчетаФактурыДокументы КАК СчетаФактурыДокументы
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	|		Документ.ТаможеннаяДекларацияИмпорт КАК ТаможеннаяДекларацияИмпорт
	...
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	|		Документ.СписаниеБезналичныхДенежныхСредств.РасшифровкаПлатежа КАК СписаниеДС_РасшифровкаПлатежа
	|	ПО
	|		ТаможеннаяДекларацияИмпорт.Ссылка = СписаниеДС_РасшифровкаПлатежа.Заказ
	|ГДЕ
