...
Функция ДеревоПредопределенных(ФильтрПоТипуОтчетов = "Внутренний") Экспорт
	...
	Если ФильтрПоТипуОтчетов = Неопределено Или ФильтрПоТипуОтчетов = "Внутренний" Тогда
		...
		ИнтеграцияСтандартныхПодсистем.ПриНастройкеВариантовОтчетов(ДеревоВариантов);
...
Функция ОбъектыСКомандамиОтчетов() Экспорт
	...
	ИнтеграцияСтандартныхПодсистем.ПриОпределенииОбъектовСКомандамиОтчетов(Результат);
...
// [2.4.1.1] Удаление устаревших отложенных разделенных обработчиков обновления.
Процедура УдалитьУстаревшиеОбработчики(Параметры = Неопределено) Экспорт
	...
	ОбновлениеИнформационнойБазы.УдалитьОтложенныйОбработчикИзОчереди("ВариантыОтчетов.ОтложенноеОбновлениеОбщихДанныхКонфигурацииИнкрементальное");
