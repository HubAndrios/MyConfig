...
// Формирует структуру, содержащую описание объекта метаданных.
//
// Параметры:
//  ИмяКласса - Строка - строка с именем класса объекта метаданных.
//  ИмяОбъекта - Строка - имя объекта метаданных.
//  СтруктураИспользованияОбъекта - Структура- шаблон описания объекта, с полями:
//  	* Реквизиты - Структура - описание реквизитов объекта.
//      * ТабличныеЧасти - Структура - описание табличных частей объекта.
//
// Возвращаемое значение:
...
Функция ПолучитьТаблицуЗаписейРегистраСведений(СтруктураОписанияОбъекта, СтруктураНастроекОтбора, МассивПолей, СтруктураПараметровНастройкиОбмена, УзелОбмена)
	...
	ТекстЗапроса = ПолучитьТекстЗапросаДляВыборкиПолейРегистраСведений(СтруктураОписанияОбъекта.ИмяОбъекта,
																		СтруктураОписанияОбъекта.ИмяТаблицы,
																		МассивПолей,
																		Ложь);
