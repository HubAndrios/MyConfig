...
Функция ДобавитьКомандуДвиженияДокумента(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.ДвиженияДокумента) Тогда
		...
		КомандаОтчет.Менеджер = Метаданные.Отчеты.ДвиженияДокумента.ПолноеИмя();
...
//	КомандыОтчетов - ТаблицаЗначений - состав полей см. в функции МенюОтчеты.СоздатьКоллекциюКомандОтчетов
//
Функция ДобавитьКомандуГотовностьОборудования(КомандыОтчетов) Экспорт
	
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.ГотовностьОборудования) Тогда
		
		КомандаОтчет = КомандыОтчетов.Добавить();
		
		КомандаОтчет.Менеджер = Метаданные.Отчеты.ГотовностьОборудования.ПолноеИмя();
		КомандаОтчет.Представление = НСтр("ru = 'Готовность оборудования'");
		
		
		КомандаОтчет.Важность = "Обычное";
		КомандаОтчет.МножественныйВыбор = Ложь;
		
		КомандаОтчет.ДополнительныеПараметры.Вставить("ИмяКоманды", "ГотовностьОборудования");
		КомандаОтчет.ДополнительныеПараметры.Вставить("Номенклатура", "СостояниеАссортимента");
