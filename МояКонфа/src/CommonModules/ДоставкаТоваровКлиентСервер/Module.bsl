...
//
Процедура УстановитьСтраницуДоставки(ЭлементыФормы, СпособДоставки, ИспользоватьЗаданияНаПеревозкуДляУчетаДоставкиПеревозчиками = Неопределено, ЭтоРаспоряжениеПоСоглашению = Ложь) Экспорт
	
	Если ЭтоРаспоряжениеПоСоглашению Тогда
	...
	Если ТипЗнч(Распоряжение) = Тип("ДокументСсылка.ЗаказПоставщику")
		...
		Или (ТипЗнч(Распоряжение) = Тип("ДанныеФормыСтруктура")
			...
			И (ТипЗнч(Распоряжение.Ссылка) = Тип("ДокументСсылка.ЗаказПоставщику")
				...
				Или ТипЗнч(Распоряжение.Ссылка) = Тип("СправочникСсылка.СоглашенияСПоставщиками")) Тогда
		Возврат Истина;
	Иначе
		Возврат Ложь;
	КонецЕсли;
