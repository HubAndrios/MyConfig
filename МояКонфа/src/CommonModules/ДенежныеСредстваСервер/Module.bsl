...
Процедура ЗаполнитьДокументПоЗаявкамНаРасходованиеДенежныхСредств(ДанныеЗаполнения, ТабличнаяЧасть, ФормаОплаты) Экспорт
	...
	|ИЗ (
	|	ВЫБРАТЬ
	|		РасшифровкаЗаявки.Партнер,
	|		РасшифровкаЗаявки.Заказ,
	|		ЕСТЬNULL(РасшифровкаЗаявки.Сумма, Заявка.СуммаДокумента) КАК Сумма,
	|		ВЫБОР
	|			КОГДА Заявка.ПланированиеСуммы = ЗНАЧЕНИЕ(Перечисление.СпособыПланированияОплатыЗаявок.ВВалютеВзаиморасчетов) ТОГДА
	|				РасшифровкаЗаявки.СуммаВзаиморасчетов
	|			ИНАЧЕ
	|				0
	|		КОНЕЦ КАК СуммаВзаиморасчетов,
	|		РасшифровкаЗаявки.ВалютаВзаиморасчетов,
	|		РасшифровкаЗаявки.СтатьяРасходов,
	|		РасшифровкаЗаявки.АналитикаРасходов,
	|		РасшифровкаЗаявки.АналитикаАктивовПассивов,
	|		РасшифровкаЗаявки.СтатьяДвиженияДенежныхСредств,
	|		РасшифровкаЗаявки.ДоговорКредитаДепозита,
	|		РасшифровкаЗаявки.ТипСуммыКредитаДепозита,
	|		РасшифровкаЗаявки.ДоговорЛизинга,
	|		РасшифровкаЗаявки.ТипПлатежаПоЛизингу,
	|		РасшифровкаЗаявки.ДоговорЗаймаСотруднику,
	|		РасшифровкаЗаявки.Подразделение,
	|		РасшифровкаЗаявки.НаправлениеДеятельности,
	|		РасшифровкаЗаявки.Ведомость,
	|		РасшифровкаЗаявки.СчетУчета КАК СчетУчета,
	|		РасшифровкаЗаявки.Субконто1 КАК Субконто1,
	|		РасшифровкаЗаявки.Субконто2 КАК Субконто2,
	|		РасшифровкаЗаявки.Субконто3 КАК Субконто3,
	|		РасшифровкаЗаявки.СтавкаНДС,
	|		РасшифровкаЗаявки.СуммаНДС КАК СуммаНДС,
	|		Заявка.Ссылка КАК ЗаявкаНаРасходованиеДенежныхСредств,
	|		Заявка.ПланированиеСуммы КАК ПланированиеСуммы,
	|		Заявка.Валюта КАК Валюта
	|	ИЗ
	...
	|		ПО
	|			РасшифровкаЗаявки.Ссылка = Заявка.Ссылка
	|		
	|	ГДЕ
	|		Заявка.Ссылка В(&МассивСсылок)
	|		
	...
	|		ВЫБОР
	|			КОГДА РасшифровкаПлатежа.ЗаявкаНаРасходованиеДенежныхСредств.ПланированиеСуммы = ЗНАЧЕНИЕ(Перечисление.СпособыПланированияОплатыЗаявок.ВВалютеВзаиморасчетов) ТОГДА
	...
	|		РасшифровкаПлатежа.ЗаявкаНаРасходованиеДенежныхСредств,
	|		РасшифровкаПлатежа.ЗаявкаНаРасходованиеДенежныхСредств.ПланированиеСуммы,
	|		РасшифровкаПлатежа.ЗаявкаНаРасходованиеДенежныхСредств.Валюта
	|	ИЗ
	...
	|		ПО
	|			ДенежныеСредства.Регистратор = РасшифровкаПлатежа.Ссылка
	|			
	|	ГДЕ
	...
	|		РасшифровкаПлатежа.Подразделение,
	|		РасшифровкаПлатежа.НаправлениеДеятельности,
	|		РасшифровкаПлатежа.Ссылка.Ведомость,
	|		РасшифровкаПлатежа.СчетУчета КАК СчетУчета,
	|		РасшифровкаПлатежа.Субконто1 КАК Субконто1,
	|		РасшифровкаПлатежа.Субконто2 КАК Субконто2,
	|		РасшифровкаПлатежа.Субконто3 КАК Субконто3,
...
Процедура ПереоценитьДенежныеСредстваУПодотчетныхЛиц(Организация, Дата, ПодотчетноеЛицо) Экспорт
	...
	УстановитьПривилегированныйРежим(Истина);
	Документы.ПереоценкаВалютныхСредств.ПереоценитьДенежныеСредстваУПодотчетныхЛиц(Организация, Дата, ПодотчетноеЛицо);
...
Процедура ЗаполнитьПозицииИТаблицуОплатЧека10(ПараметрыФискализацииЧека, ДанныеДокумента, СуммаПредоплатыКорректировка);
	...
	|	КОНЕЦ, ЛОЖЬ) КАК ПолнаяОплатаОснования
	|ПОМЕСТИТЬ РасшифровкаОснования
	|ИЗ
	|	Расшифровка
	|;
