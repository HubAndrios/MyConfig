...
Процедура СохранитьНеИзмененныеПервичныеДвижения()
	...
	ПоляПартий = Новый Структура("Партия, АналитикаУчетаПартий, АналитикаФинансовогоУчета, ВидДеятельностиНДС, ДокументИсточник");
	...
	// а движения измененных периодов и расчетные движения.
	ШаблонТекстаЗапроса =
	"ВЫБРАТЬ
