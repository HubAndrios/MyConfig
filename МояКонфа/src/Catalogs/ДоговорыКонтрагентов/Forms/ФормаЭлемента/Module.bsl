...
Процедура ТипДоговораПриИзмененииСервер()
	...
	Если Объект.ТипДоговора = Перечисления.ТипыДоговоров.Импорт	И ВариантОформленияЗакупок = "ДвумяДокументами" Тогда
...
Процедура УстановитьВидимостьВариантовОформленияЗакупок()
	...
	ИспользуетсяОформлениеЗакупок = Объект.ТипДоговора = Перечисления.ТипыДоговоров.СПоставщиком
									Или Объект.ТипДоговора = Перечисления.ТипыДоговоров.ВвозИзЕАЭС
									Или Объект.ТипДоговора = Перечисления.ТипыДоговоров.Импорт;
	...
	Элементы.ГруппаОформлениеЗакупок.Видимость 						= ИспользуетсяОформлениеЗакупок
