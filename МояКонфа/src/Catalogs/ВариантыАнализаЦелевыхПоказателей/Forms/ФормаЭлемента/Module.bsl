...
Процедура НастроитьОформление(Команда)
	...
	СтруктураНастроекОформления.Вставить("ГрадиентДляПокомпонетногоСравнения", 
		Объект.ГрадиентДляПокомпонетногоСравнения);
	СтруктураНастроекОформления.Вставить("ВыделятьМаксимальноеЗначениеДляПокомпонетногоСравнения", 
...
Функция СтруктураНастроекДемоДанных()
	...
	Если ДоступныеЗначенияАнализа.НайтиПоЗначению(ЗначениеАнализа) <> Неопределено Тогда
		ДоступноеПоле = ДоступныеПоляВыбора.НайтиПоле(ЗначениеАнализа);
	...
	Если ДоступныеЗначенияАнализа.НайтиПоЗначению(ЗначениеАнализаДополнительное) <> Неопределено Тогда
		ДоступноеПоле = ДоступныеПоляВыбора.НайтиПоле(ЗначениеАнализаДополнительное);
	...
	Если ДоступныеОбъектыАнализа.НайтиПоЗначению(ОбъектАнализа) <> Неопределено Тогда
		ДоступноеПоле = ДоступныеПоляГруппировок.НайтиПоле(ОбъектАнализа);
	...
	СтруктураНастроекОформления.Вставить("ГрадиентДляПокомпонетногоСравнения", Объект.ГрадиентДляПокомпонетногоСравнения);
	СтруктураНастроекОформления.Вставить("ВыделятьМаксимальноеЗначениеДляПокомпонетногоСравнения", 
		Объект.ВыделятьМаксимальноеЗначениеДляПокомпонетногоСравнения);
