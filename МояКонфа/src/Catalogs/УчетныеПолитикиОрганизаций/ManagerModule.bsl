...
// [11.4.1] Удаление устаревших отложенных разделенных обработчиков обновления.
//
Процедура УдалитьУстаревшиеОбработчики(Параметры = Неопределено) Экспорт
	...
	ОбновлениеИнформационнойБазы.УдалитьОтложенныйОбработчикИзОчереди(
		"Справочники.УчетныеПолитикиОрганизаций.ОбработатьДанныеДляПереходаНаНовуюВерсию");
