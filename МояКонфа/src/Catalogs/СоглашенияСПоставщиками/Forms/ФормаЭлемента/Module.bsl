...
Процедура ПриИзмененииХозяйственнойОперацииСервер()
	...
	УстановитьИспользованиеРаздельногоВариантаОформленияЗакупок();
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	ИспользуютсяТоварыВПути                 = ПолучитьФункциональнуюОпцию("ИспользоватьТоварыВПутиОтПоставщиков");
	ИспользуютсяНеотфактурованныеПоставки   = ПолучитьФункциональнуюОпцию("ИспользоватьНеотфактурованныеПоставки");
...
&НаСервере
Процедура УстановитьИспользованиеРаздельногоВариантаОформленияЗакупок()
	...
	Если (Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ЗакупкаУПоставщика
		...
		И ПриемкаТоваров = "НеРазделена" Тогда
...
Процедура УстановитьОтметкуНезаполненногоВидаЦеныПоставщика()
	...
	Если Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПриемНаХранениеСПравомПродажи 
		Или ИспользуетсяРаздельныйВариантОформленияЗакупок Тогда
