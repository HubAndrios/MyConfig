...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(АгентскаяУслугаНоменклатура) Тогда
		Элементы.ОтборАгентсткаяУслуга.Видимость = Ложь;
		Элементы.ДобавитьУслугуВСоглашение.Видимость = Ложь;
	Иначе
		
		Элементы.ОтборАгентсткаяУслуга.СписокВыбора[0].Представление =
					НоменклатураКлиентСервер.ПредставлениеНоменклатуры(АгентскаяУслугаНоменклатура, АгентскаяУслугаХарактеристика);
					
		Если Параметры.ВключитьОтборПоАгенсткойУслуге Тогда
			ОтборАгентсткаяУслуга = "ТолькоДляНоменклатуры";
		КонецЕсли;
...
Процедура УстановитьОтборПоАгентскойУслуге()
	...
	Если ОтборАгентсткаяУслуга = "ТолькоДляНоменклатуры" Тогда
