...
Процедура ПодробноНаСервере()
	КомпоновщикНастроек = Отчеты.ГотовностьОборудования.Создать().КомпоновщикНастроек;
	Настройки = КомпоновщикНастроек.Настройки;
	ЭлементНастройки = Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("Номенклатура"));
	ЭлементНастройки.Значение = ЭтотОбъект.ТекущийЭлемент;
	...
	ФормаОтчета = Отчеты.ГотовностьОборудования.ПолучитьФорму();
