...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТЗ=ОбщегоНазначения_аккую.ПолучитьСостояниеПоДокументам(Объект.Ссылка);
	//Для Каждого строки из тз Цикл 
	//	ЭтотОбъект.СостояниеПоДокументам.Добавить(строки.Регистратор.Метаданные().Имя+"="+Строка(строки.Состояние));
	//КонецЦикла;

	 ЗначениеВРеквизитФормы(ТЗ, "СостояниеПоДокументам");
КонецПроцедуры
