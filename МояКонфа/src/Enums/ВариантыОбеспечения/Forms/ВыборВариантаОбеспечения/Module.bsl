...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// служебный реквизит для формирования информационной надписи внизу списка
	ШаблонПоступилоПод = ШаблонПоступилоПод(Параметры.Отбор.Назначение);
...
&НаСервереБезКонтекста
Функция ШаблонПоступилоПод(Назначение)
	
	Если Не ЗначениеЗаполнено(Назначение) Тогда
		
		СтрокаПодстановки = НСтр("ru = 'Поступило под заказ'");
		
	Иначе
		
		Шаблоны = Справочники.Назначения.ШаблоныИзСсылок(ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Назначение));
		ШаблонНазначения = Шаблоны.Получить(Назначение);
		НаправлениеДеятельности = ШаблонНазначения.НаправлениеДеятельности;
		Договор = ШаблонНазначения.Договор;
		Партнер = ШаблонНазначения.Партнер;
		
		Если ЗначениеЗаполнено(НаправлениеДеятельности) И ЗначениеЗаполнено(Договор) Тогда
			
			СтрокаПодстановки = НСтр("ru = 'Поступило под договор по направлению деятельности'");
			
		ИначеЕсли ЗначениеЗаполнено(НаправлениеДеятельности) И ЗначениеЗаполнено(Партнер) Тогда
			
			СтрокаПодстановки = НСтр("ru = 'Поступило под давальца по направлению деятельности'");
			
		ИначеЕсли ЗначениеЗаполнено(НаправлениеДеятельности) Тогда
			
			СтрокаПодстановки = НСтр("ru = 'Поступило под направление деятельности'");
			
		ИначеЕсли ЗначениеЗаполнено(Договор) Тогда
			
			СтрокаПодстановки = НСтр("ru = 'Поступило под договор'");
			
		ИначеЕсли ЗначениеЗаполнено(Партнер) Тогда
			
			СтрокаПодстановки = НСтр("ru = 'Поступило под давальца'");
