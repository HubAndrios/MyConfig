...
Процедура ПолучитьДанныеПоШтрихкодам(КэшированныеЗначения, Штрихкоды) Экспорт
	...
	|	
	|	ВЫБОР КОГДА КлассификаторАлкогольнойПродукцииЕГАИСУпаковки.Ссылка ЕСТЬ NULL ТОГДА
	|		ЕСТЬNULL(ШтрихкодыНоменклатуры.Номенклатура.ВидАлкогольнойПродукции.Маркируемый, Ложь)
	|	ИНАЧЕ
	|		ЕСТЬNULL(КлассификаторАлкогольнойПродукцииЕГАИСУпаковки.Ссылка.ВидПродукции.Маркируемый, Ложь)
	...
	|		ПО (КлассификаторАлкогольнойПродукцииЕГАИСУпаковки.Ссылка.Номенклатура = ШтрихкодыНоменклатуры.Номенклатура)
	|			И (КлассификаторАлкогольнойПродукцииЕГАИСУпаковки.Ссылка.Характеристика = ШтрихкодыНоменклатуры.Характеристика)
	|			И (КлассификаторАлкогольнойПродукцииЕГАИСУпаковки.Упаковка = ШтрихкодыНоменклатуры.Упаковка)
	|		
	|ГДЕ
