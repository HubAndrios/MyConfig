...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РежимРаботы = "ЗАГРУЗКА" Тогда
		...
		ДанныеАутентификацииСайтаСохранены = ДанныеАутентификацииСайтаСохранены();
		Элементы.АвторизацияНаСайтеПоддержкиПользователей.Видимость = НЕ ДанныеАутентификацииСайтаСохранены;
		Элементы.ИнформацияОбОбновление.Видимость = ДанныеАутентификацииСайтаСохранены;
