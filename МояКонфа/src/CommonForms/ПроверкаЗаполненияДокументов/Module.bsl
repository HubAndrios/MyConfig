...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	АкцизныеМаркиЕГАИС.ЗаполнитьСлужебныеРеквизиты(ЭтотОбъект, "КоличествоФакт");
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если Источник = "ПодключаемоеОборудование" И ВводДоступен() Тогда
		Если ИмяСобытия = "ScanData" И МенеджерОборудованияКлиентПереопределяемый.ЕстьНеобработанноеСобытие() Тогда
			...
			Если Не АкцизныеМаркиЕГАИСКлиент.СчитанаАкцизнаяМарка(
				ЭтотОбъект,
				ТекущиеДанные,
				ДанныеШтрихкодов,
				"КоличествоФакт") Тогда
...
Процедура АкцизныеМарки(Команда)
	...
	ДополнительныеПараметры.Вставить("ИмяКолонкиКоличество", "КоличествоФакт");
...
Процедура ОбработатьШтрихкоды(ДанныеШтрихкодов)
	...
	Если ИспользоватьАкцизныеМарки Тогда
		...
		СтруктураДействийСДобавленнымиСтроками.Вставить("ЗаполнитьНоменклатуруЕГАИС");
	КонецЕсли;
